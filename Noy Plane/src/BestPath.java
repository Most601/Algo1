...
public class BestPath {
	...
	public boolean isOnBestPath(int i,int j) {
		return (mat[i][j].price + bestPathFromTo(i,j,mat.length-1,mat[0].length-1)) == cheapestPrice;
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(bp.getOneCheapestPathRec());
		System.out.println(bp.getAllCheapestPathRec());
